...
public class CommandCreate implements CommandCallable {
    ...
    public CommandResult process(CommandSource source, String arguments) throws CommandException {
        ...
        if (source instanceof Player) {
            ...
            if (contains(regionsAliases, args[0])) {
                int flag = 0;
                Optional<World> optWorld = parseWorld(args[1], FoxGuardMain.getInstance().getGame().getServer());
                World world;
                ...
                IRegion newRegion;
                if (contains(rectAliases, args[2 + flag])) {
    ...
    private Optional<World> parseWorld(String arg, Server server) {
